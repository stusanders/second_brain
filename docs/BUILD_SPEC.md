...
### Export
A `export_wiki()` operation that produces a downloadable archive of the markdown files plus a manifest (links, metadata, source refs). Cheap given blob already holds files in this shape, and doubles as the user-facing backup story.
